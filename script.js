...
$("#buttons").mousemove(function(){
    let speed = ($("#stepsPerSec").val() === "2") ? "7" : ($("#stepsPerSec").val() === "3") ? "30" : "2"
    let display = (speed === "7") ? "Medium" : (speed === "30") ? "Fast" : "Slow"
$("#stepsPerSecOutput").text(display)
s.stepsPerSecond = Number(speed)
});
function step(){
var i = 0
    while(i < 626){
